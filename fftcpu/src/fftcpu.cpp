...
/* Builtin:Arrange binary number into reverse order */
...
/* Builtin:Used for assignment of single array element */
template<typename T>
...
/* API:Typename T can be float or complex<float>,n1 must be 2^int */
template<typename T>
...
/* API:Typename T can be float or complex<float>,n1 and n2 must be 2^int */
template<typename T>
